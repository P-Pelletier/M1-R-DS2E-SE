...
download_link(
  link = "https://github.com/master-ds2e/M1-Programming/raw/master/data/covid_papers.zip",
...
library(downloadthis)
download_link(
  link = "https://github.com/master-ds2e/M1-Programming/raw/master/data/data.zip",
  button_label = "Download Data",
  button_type = "danger",
  has_icon = TRUE,
  icon = "fa fa-save",
